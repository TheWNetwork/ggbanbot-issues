...
Los bots **@elsabanbot** y **@ggbanbot** procesan de forma automatizada la actividad en los chats donde están presentes (mensajes de texto, archivos multimedia, identificadores únicos de usuario/grupo, alias, nombres de usuario y registros de sanciones/vetos) con las siguientes finalidades exclusivas:

1. **Moderación de contenidos y gestión de sanciones:** Prevenir el spam, el acoso y gestionar listas de veto (*banlists*) o restricciones dentro de los grupos para mantener la seguridad comunitaria.
...
* **Tratamiento habitual y registros de moderación:** Los mensajes cotidianos se procesan en tiempo real para las labores de moderación. Los registros de vetos y sanciones (ID de usuario y motivo de sanción) se conservan mientras sea necesario para la aplicación efectiva de la seguridad en los grupos.
